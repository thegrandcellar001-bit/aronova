...
export default function StepFour({
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      const { payment_authorization_url } = res.data;
  ...
  return (
    <div>
        ...
        <div className="flex flex-col gap-3 rounded-md border-2 border-primary p-4">
          {userAddress ? (
            <div>
              ...
              <div className="mt-2">
                <p className="text-md text-black font-medium">{user.name}</p>
          ...
          <div>
            ...
            <div className="mt-2">
              ...
              <p className="text-sm text-black/60 mt-1">
                You'll be redirected to our payment gateway to complete your
                purchase.
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-3 rounded-md border-2 border-primary p-4 mt-4">
        <div>
          <p className="text-md font-medium text-black">
            <i className="far fa-truck text-md mr-1"></i> Delivery Method
          </p>
          <div className="mt-2">
