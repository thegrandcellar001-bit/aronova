        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="font-sans text-lg text-muted-foreground mb-8 leading-relaxed">
              Authenticated designer resale — verified, loved, and reborn.
              Aronova Resell gives luxury a second life with integrity intact.
            </p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="font-sans text-muted-foreground">
                    Every piece verified by experts
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="font-sans text-muted-foreground">
                    Digital documentation of authenticity
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
          ...
          <div className="relative h-[600px] bg-muted animate-scale-in">
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="text-2xl text-muted-foreground italic px-8 text-center">
