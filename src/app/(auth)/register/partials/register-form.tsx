    ...
    <form className={cn("flex flex-col gap-4", className)} {...props}>
      ...
      <div className="grid gap-3 my-1">
        ...
        <div className="space-y-3">
          ...
          />
          <a
            className="flex items-center gap-x-2 cursor-pointer text-sm mb-1"
            onClick={togglePasswordVisibility}
          >
            <i
              className={showPassword ? "fas fa-lock" : "fas fa-lock-open"}
            ></i>{" "}
      ...
      <div className="text-center text-sm">
        Already have an account? <i className="far fa-arrow-right mx-2"></i>
        <Link href="/login" className="underline underline-offset-8">
          Login
        </Link>
      </div>
    </form>
